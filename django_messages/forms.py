...
class ComposeForm(forms.Form):
    ...
    """
    recipient = CommaSeparatedUserField(label=_(u"Recipient E-Mail"))
    subject = forms.CharField(label=_(u"Message Subject"), max_length=60)
    body = forms.CharField(label=_(u"Message Body"), max_length=150,
